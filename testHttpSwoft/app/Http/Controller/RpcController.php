...
class RpcController
{
    ...
    {
        Log::debug(__METHOD__.' userService:'.get_class($this->userService).
        ' userService2:'.get_class($this->userService2).' pid:'.posix_getpid());
     ...
     * Notes:
     * User: user_1234
     * DateTime: 2019/9/26 19:17
     * @return array
     * @throws \ReflectionException
     * @throws \Swoft\Bean\Exception\ContainerException
     */
    public function rpcCall(): array
    {
        Log::debug(__METHOD__.' called:');
        $ret = request('tcp://127.0.0.1:18307', UserInterface::class,
            'getList',  [3, 4], "1.0");
